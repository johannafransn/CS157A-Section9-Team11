    ...
    <div class="container-fluid padding">
        <div class="text-center">
            ...
            try{
                ...
                ResultSet rs=stmt.executeQuery("SELECT p.product_name, p.product_description, p.price FROM grocerymart.products p JOIN grocerymart.categories c WHERE c.product_id = p.product_id AND c.product_type = 'Dry Food';");
                while(rs.next())
